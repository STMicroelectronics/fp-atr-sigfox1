...
/* S2868A1_RADIO_GPIO_1 is set as EXTI */
#define S2LP_NVIC_GPIO_1_DisableIRQ()	HAL_NVIC_DisableIRQ( S2868A1_RADIO_GPIO_1_IRQn)
#define S2LP_NVIC_GPIO_1_EnableIRQ()	HAL_NVIC_EnableIRQ( S2868A1_RADIO_GPIO_1_IRQn)

/* S2868A1_RADIO_GPIO_2 is NOT set as EXTI */
#define S2LP_NVIC_GPIO_2_DisableIRQ()
#define S2LP_NVIC_GPIO_2_EnableIRQ()

/* S2868A1_RADIO_GPIO_3 is NOT set as EXTI */
...
#define S2868A1_RADIO_GPIO_1_IRQn                            EXTI4_15_IRQn
#define H_EXTI_4                                             S2868A1_RADIO_GPIO_hexti[0]
#define S2868A1_RADIO_GPIO_1_MODE                            RADIO_MODE_EXTI_IN
#define S2868A1_RADIO_GPIO_1_EXTI_MODE                       GPIO_MODE_IT_RISING
#define S2868A1_RADIO_GPIO_1_IT_PRIO                         0
#define S2868A1_RADIO_GPIO_1_IT_SUBPRIO                      0
#define S2868A1_RADIO_GPIO_1_SPEED                           GPIO_SPEED_FREQ_HIGH /* This value is not used for EXTI mode */
...
#define S2868A1_RADIO_GPIO_SDN_PORT                          GPIOB
#define S2868A1_RADIO_GPIO_SDN_CLOCK_ENABLE()                __HAL_RCC_GPIOB_CLK_ENABLE()
#define S2868A1_RADIO_GPIO_SDN_PIN                           GPIO_PIN_10
